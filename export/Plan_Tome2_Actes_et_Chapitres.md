---
title: "Tome 2 — Hildegarde : Plan Directeur Révisé (Épique, Histoire & Suspens)"
saga: "Les Schattenjägers"
author: "Danoë (Daniel Muller)"
version: "3.5 (Master Épique & Thriller Médiéval)"
date: "2026-09-06"
format: "Obsidian Vault Structure"
tags:
  - schattenjagers
  - tome2
  - master-plan
...
```mermaid
graph TD
    subgraph Terre [Cycle Terrestre 1098-1179 : De l'Emmurement à la Souveraineté]
        Cadre[Cadre Narratif : Le Dernier Soir 1179] --> Acte1[Acte I : L'Enfance et l'Emmurement 1098-1114]
        Acte1 --> Acte2[Acte II : La Flamme et l'Ombre 1115-1136]
        Acte2 --> Acte3[Acte III : La Chasseresse de Ténèbres 1137-1147]
        Acte3 --> Acte4[Acte IV : L'Abbesse de Rupertsberg 1148-1154]
        Acte4 --> Acte5[Acte V : La Prophétesse et l'Empereur 1155-1174]
        Acte5 --> Acte6[Acte VI : Le Crépuscule et le Legs 1175-1179]
    end
    subgraph Ciel [Cycle Céleste 1347+ : Guerre Totale contre l'Étranger]
        Acte6 --> Acte7[Acte VII : L'Archangeline et les Fléaux Séculaires]
    end
```
...
```mermaid
graph TD
    D["DANOË (Voix, Style & Direction Artistique)<br/>• Narration Cosmico-Lyrique (Nunael) & Corps Incarné (Hildegarde)<br/>• Chef d'orchestre & Réécriture finale de toutes les scènes"]

    D --> H["HISTOIRE (Rigueur Documentaire XIIe s.)<br/>• Vie monastique bénédictine & réclusion réelle<br/>• Querelles féodales des dots & institutions canoniques<br/>• Schisme impérial de Frédéric Barberousse<br/>• Disputatio de Paris, conciles & latin liturgique"]

    D --> A["AVENTURE & ÉPIQUE (Quêtes & Combats)<br/>• Infiltration de sanctuaires & cryptes carolingiennes<br/>• Traques nocturnes sur le Rhin (Mäuseturm)<br/>• Assaut de forteresses & sauvetage d'Alma<br/>• Guerre céleste contre la Peste Noire (Marseille 1347)"]

    D --> S["SUSPENS & THRILLER (Tension & Danger)<br/>• Menace de mort permanente & ticking clocks<br/>• Société secrète des Enfants de Lilith & infiltrés<br/>• Poisons bio-chimiques (ergot, aconit) & médecine légale<br/>• Art de la Chute : fins de chapitres tranchées"]

    style D fill:#1a365d,stroke:#63b3ed,stroke-width:3px,color:#fff
    style H fill:#22543d,stroke:#9ae6b4,stroke-width:2px,color:#fff
    style A fill:#7b341e,stroke:#fbd38d,stroke-width:2px,color:#fff
    style S fill:#4a154b,stroke:#feb2b2,stroke-width:2px,color:#fff
```
